...
void gen_quality_map_wmemory(int *QualMap, int *direction_map, int *low_contrast_map,
					int *low_flow_map, int *high_curve_map,
					const int map_w, const int map_h)
{
...
double grayscale_reliability_wmemory(Minutia *minutia, unsigned char *idata,
                             const int iw, const int ih, const int radius_pix)
{
   double mean, stdev;
   double reliability;

   get_neighborhood_stats_wmemory(&mean, &stdev, minutia, idata, iw, ih, radius_pix);
...
void get_neighborhood_stats_wmemory(double *mean, double *stdev, Minutia *minutia,
                     unsigned char *idata, const int iw, const int ih,
                     const int radius_pix)
{
   int i, x, y, rows, cols;
